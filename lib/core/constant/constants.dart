class Constant {
  ...
  */
  ...
  static final RegExp localStorageFileDetectorUniversal =
      RegExp(r'^(?:(?:[a-zA-Z]:\\|\\\\[^\\/:*?"<>|\r\n]+\\[^\\/:*?"<>|\r\n]+\\|\/)'
          r'(?:[^\\/:*?"<>|\r\n]+[\\\/])*'
          r'[^\\/:*?"<>|\r\n]*'
          r'(?:\.[^\\/:*?"<>|\r\n]+)?)$');
  ...
  static final RegExp localStorageFileDetectorAndroid =
      RegExp(r'^(?:\/(?:[a-zA-Z0-9\-_]+(?:\/[a-zA-Z0-9\-_]+)*)?(?:\.[a-zA-Z0-9\-_]+)?)$');

  /// Check if the file comes from a content uri data
  static final RegExp contentUriFileDetector = RegExp(r'^content:\/\/([a-zA-Z0-9\-_]+(?:\/[a-zA-Z0-9\-_]+)*)$');
