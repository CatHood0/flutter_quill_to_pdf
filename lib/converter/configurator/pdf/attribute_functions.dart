...
mixin AttrBlockFunctions<B, TS> {
  ...
  Future<B> getAlignedHeaderBlock(List<pw.InlineSpan> spansToWrap,
      int headerLevel, String align, int indentLevel,
      [TS? style]);
  Future<B> getAlignedParagraphBlock(
      List<pw.InlineSpan> spansToWrap, String align, int indentLevel,
      [TS? style]);
  Future<B> getListBlock(List<pw.InlineSpan> spansToWrap, String typeList,
      String align, int indentLevel,
      [TS? style]);
  Future<B> getHeaderBlock(
...
mixin AttrInlineBlockFunctions<I, TS> {
  ...
  Future<I> getAlignedHeaderBlock(List<pw.InlineSpan> spansToWrap,
      int headerLevel, String align, int indentLevel,
      [TS? style]);
  Future<I> getAlignedParagraphBlock(
      List<pw.InlineSpan> spansToWrap, String align, int indentLevel,
      [TS? style]);
  Future<I> getListBlock(List<pw.InlineSpan> spansToWrap, String typeList,
      String align, int indentLevel,
      [TS? style]);
  Future<I> getHeaderBlock(
      List<pw.InlineSpan> spansToWrap, int headerLevel, int indentLevel,
      [TS? style]);
}
