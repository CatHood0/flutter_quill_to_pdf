...
class DeltaInsertOp {
  DeltaInsertOp(Object /*InsertData | string*/ insertVal, [OpAttributes? attrs]) {
  ...
  isContainerBlock() {
    return (isBlockquote() || isList()  || isTable() || isCodeBlock() || isHeader() || isBlockAttribute() || isCustomTextBlock());
  }
  ...
  bool hasSameAttr(DeltaInsertOp op) {
    return DeepCollectionEquality().equals(attributes.attrs, op.attributes.attrs);
  }
  ...
  bool isSameTableRowAs(DeltaInsertOp op) {
    return (op.isTable() && isTable() && attributes.table == op.attributes.table);
  }
  ...
  bool operator ==(Object other) =>
      ...
      other is DeltaInsertOp && runtimeType == other.runtimeType && insert == other.insert && attributes == other.attributes;
