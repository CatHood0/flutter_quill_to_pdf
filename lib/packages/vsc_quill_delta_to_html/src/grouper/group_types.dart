...
class InlineGroup implements TDataGroup {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is InlineGroup && runtimeType == other.runtimeType && ListEquality().equals(ops, other.ops);
...
class SingleItem {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SingleItem && runtimeType == other.runtimeType && op == other.op;
...
class BlockGroup implements TDataGroup {
  ...
  bool operator ==(Object other) =>
      ...
      other is BlockGroup && runtimeType == other.runtimeType && op == other.op && ListEquality().equals(ops, other.ops);
...
class ListGroup implements TDataGroup {
  ...
  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is ListGroup && runtimeType == other.runtimeType && ListEquality().equals(items, other.items);
...
class ListItem implements TDataGroup {
  ...
  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is ListItem && runtimeType == other.runtimeType && item == other.item && innerList == other.innerList;
...
class TableGroup implements TDataGroup {
  ...
  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is TableGroup && runtimeType == other.runtimeType && ListEquality().equals(rows, other.rows);
...
class TableRow implements TDataGroup {
  ...
  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is TableRow && runtimeType == other.runtimeType && ListEquality().equals(cells, other.cells);
...
class TableCell implements TDataGroup {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TableCell && runtimeType == other.runtimeType && item == other.item;
