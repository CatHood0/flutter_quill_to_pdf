...
Map<String, TextStyle> createCustomHighlightTheme(
    {required TextStyle Function(String typeVar) styleBuilder,
    Map<String, TextStyle>? alternativeTheme}) {
  if (alternativeTheme != null && alternativeTheme.isNotEmpty)
